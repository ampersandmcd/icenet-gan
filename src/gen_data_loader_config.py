"""
Adapted from Tom Andersson's https://github.com/tom-andersson/icenet-paper/blob/main/icenet/rotate_wind_data.py
...
def gen_data_loader_config():
    ...
    dataloader_config = {
        'dataloader_name': 'icenet_gan',
        'dataset_name': 'dataset_no_cmip',
        'input_data': {
            "siconca":
                {"abs": {"include": True, 'max_lag': 12},
                "anom": {"include": False, 'max_lag': 3},
        ...
        'batch_size': 1,  # in the icenet-gan implementation batch_size is set in the training loop when we construct a 
                          # torch.utils.data.DataLoader object; hence must should be 1
        'shuffle': True,
        'n_forecast_months': 6,
        'sample_IDs': {
            'obs_train_dates': ('1980-1-1', '2011-6-1'),
