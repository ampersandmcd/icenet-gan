...
def rotate_wind_data(cmip6=False, source_id=None, member_id=None):
    """
    ...
    :param cmip6: Rotate CMIP6 wind rather than ERA5
    :param source_id: CMIP source model
    :param member_id: CMIP scenario member
    """
    ...
    if gen_video:
        for var in ['uas', 'vas']:
            ...
            os.environ["IMAGEIO_FFMPEG_EXE"] = config.IMAGEIO_FFMPEG_EXE
